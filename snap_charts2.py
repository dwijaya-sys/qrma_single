...
async def snap(theme):
    async with async_playwright() as pw:
        ...
        await page.wait_for_function(
            ...
            timeout=8000)
        # Scroll so radar/bar charts are in view
        await page.evaluate("() => document.getElementById('radarChart').scrollIntoView()")
        await page.screenshot(path=str(SS / f"qa_chartview_{theme}.png"))
        await browser.close()
        print(f"{theme} done")
